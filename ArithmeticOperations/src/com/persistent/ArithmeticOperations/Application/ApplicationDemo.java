...
public class ApplicationDemo {
	...
	public static void basicOperations(int n,int n1) throws MyException{
		 ArithmeticOperationsImpl arithmeticOperations = new  ArithmeticOperationsImpl();
		 ...
		 if(n1==0)
			 throw new MyException("Division operations cannot be performed.Divide by zero");
		 else{
